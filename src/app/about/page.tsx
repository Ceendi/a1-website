...
export default function About() {
  return (
    ...
    >
      <div className="min-h-screen px-6 py-12 lg:py-12 lg:ml-64">
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <div className="bg-white/5 rounded-2xl p-8 border border-white/10">
              ...
              <p className="text-gray-300 text-lg leading-relaxed">
                Jesteśmy firmą architektoniczną, która tworzy wizualne
                rozwiązania dla klientów. Pasją naszego zespołu jest tworzenie
                wizualnych rozwiązań, które są niezwykłe i piękne. Cechujemy się

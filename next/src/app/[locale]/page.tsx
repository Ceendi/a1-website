...
export default function Home() {
  return (
    ...
    >
      <div className="min-h-screen absolute top-0 left-0 lg:ml-16">
        <div className="text-start">
          <div className={`mt-8 mb-8 ${montserrat.className} font-bold`}>
            <div className="text-xs sm:text-base md:text-base tracking-[10px] sm:tracking-[14px] md:tracking-[18px] font-light ml-2 sm:ml-[30px] md:ml-[65px]">
